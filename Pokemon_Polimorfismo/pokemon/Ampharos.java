...
public class Ampharos extends PokemonDosTipos implements Pokemon {

    private double danio;

    public Ampharos(String nombre, int ps, int ataque, int defensa, int ataqueEspecial, int defensaEspecial, double velocidad, int nivel, Tipo tipo1, Tipo tipo2, String clase) {
